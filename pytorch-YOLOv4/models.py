...
if  __name__ == "__main__":
    ...
    for i in range(len(text)):
      ...
      if count == 0: #chicken
        cal=cal+55
      if count == 1: #chicken rice
        cal=cal+267
      if count == 2: #crispy noodle with pork
        cal=cal+393
      if count == 3: #pork rice
        cal=cal+192
      if count == 4: #shrimp paste
        cal=cal+330
      if count == 5: #chinese sausage
        cal=cal+82
      if count == 6: #dry shrimp
        cal=cal+13
      if count == 7: #egg
        cal=cal+40
      if count == 8: #leg pork
      ...
      if count == 13: #shrimp
        cal=cal+46
      if count == 14: #stir fried
        cal=cal+382
      if count == 15: #sweet pork
        cal=cal+161
    print('calories=',cal)